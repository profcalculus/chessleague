...
class TestAPI(unittest.TestCase):
    ...
    #     rv, json = good_client.get('/players/')
    ...
    #     rv, json = bad_client.get('/players/')
    ...
    def test_players(self):
        ...
        # # create new player
        rv, json = self.client.post('/players/',
                                    data={'first_name': 'Igor', 'last_name': 'Borisovitch',
                                          'dob': '1945-01-01'})
        ...
        self.assertEqual('1945-01-01', json['dob'])
        self.assertEqual(igor_url, json['uri'])

        # create new player
        rv, json = self.client.post('/players/',
                                    data={'first_name': 'Boris', 'last_name': 'Igorevitch',
                                          'dob': '1945-12-28'})
        self.assertEqual(201, rv.status_code)
        ...
        self.assertEqual('1945-12-28', json['dob'])
    ...
    def test_teams(self):
        ...
        # create bad request
        # rv,json = self.client.post('/players/', data={})
    ...
    #     rv, json = self.client.get('/players/?page=1&per_page=2')
    #     self.assertEqual(200, rv.status_code)
